           ...
           <div>
             <div className={`${isLeft ?"justify-start ml-3 mr-20" :"justify-end mr-3 ml-20" } min-w-[20%] flex `}>
                <div className="flex flex-col ">
                    {amount != 0 && <div className="bg-[color:var(--primary-btn)] text-lg px-1 rounded-t-lg text-pretty">
                        {amount}
                    </div>}
                    <div className={`${amount == 0 ? "rounded-t-lg":""}  bg-[color:var(--primary-btn)] text-lg px-1 rounded-b-md text-pretty`}>
                        {note}
                    </div>
                </div>
            </div>
